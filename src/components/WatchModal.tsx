                ...
                <>
                  ...
                  {embedIdx + 1 < EMBED_SOURCES.length && (
                    <button
                      ...
                      className="flex items-center gap-2 bg-red-600 hover:bg-red-500 active:bg-red-700 text-white text-xs font-bold px-4 py-2 rounded-lg transition-colors shadow-lg"
                      title="If the player shows an error, tap this to try a different one"
                    >
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
